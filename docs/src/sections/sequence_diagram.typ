...
#seq_diagram(
  [#ria() getSellPageInfo sequence diagram],
  diagram({
    _par("A", display-name: "auction.html")
    _par("B", display-name: [js.js])
...
#seq_diagram(
  [#ria() getBuyPageInfo sequence diagram],
  diagram({
    _par("A", display-name: "auction.html")
    _par("B", display-name: [js.js])
...
#seq_diagram(
  [#ria() uploadItem sequence diagram],
    diagram({
      _par("A", display-name: "auction.html")
      _par("B", display-name: [js.js])
...
#seq_diagram(
  [#ria() getDetailedPageInfo sequence diagram],
  diagram({
    _par("A", display-name: "auction.html")
    _par("B", display-name: [js.js])
...
#seq_diagram(
  [#ria() createAuction sequence diagram],
  diagram({
    _par("A", display-name: "auction.html")
    _par("B", display-name: [js.js])
    _par("C", display-name: "AuctionServlet")
...
#seq_diagram(
  [#ria() getOfferPageInfo sequence diagram],
  diagram({
    _par("B", display-name: [js.js])
    _par("A", display-name: "auction.html")
